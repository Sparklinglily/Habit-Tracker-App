...
import 'package:habit_help/constants/constants.dart';
import 'package:habit_help/FirebaseAuthServices/authMethods.dart';
import 'package:provider/provider.dart';
import 'package:email_validator/email_validator.dart';

import '../FirebaseAuthServices/widgets/showSnackBar.dart';
...
class _ForgotPasswordState extends State<ForgotPassword> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> uponPress(email) async{
      try{
       await context.read<FirebaseAuthMethods>().passwordResetLink(email, context);
