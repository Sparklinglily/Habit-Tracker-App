...
import 'package:habit_help/chat/chatService/chatService.dart';
...
class ChatPage extends StatefulWidget {
  ...
  const ChatPage({
    ...
    Key? key,required this.receiverUserEmail,required this.receiverUserId}) : super(key: key);
...
Widget _buildMessageInput (){
    return Row(
      children: [
        ...
        //send button
        IconButton(onPressed: sendMessage, icon: Icon(Icons.send_rounded,size: 35,))
      ],
    );
