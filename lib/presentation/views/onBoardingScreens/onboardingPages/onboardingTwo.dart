...
import 'package:habit_help/presentation/views/onBoardingScreens/onboardingPages/onboardingThree.dart';
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                const Image(
                    image: AssetImage("images/healthyHabit.png"),
                    height: 300,
                    width: 300),
                ...
                const Padding(
                  padding:
                      EdgeInsets.symmetric(horizontal: defaultSpacing * 1.5),
                  child: Text(
                    "Forming new and healthy habits is an "
