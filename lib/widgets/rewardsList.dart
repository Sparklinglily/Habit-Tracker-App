...
class _RewardListState extends State<RewardList> {
  final sleeping = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTclYYJIAS5EfjGG8FdwopkB1MeFhewElWZkFfar6ogNU6kLsCqPi2W-7XmDEuort7nX3o&usqp=CAU";
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: ElevatedButton(
        ...
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>const Achievement(),
          ));
        },
        child: Row(
          ...
          children: [
            CircleAvatar(
             ...
             const Text("Get at least 7 hours of sleep",style:
            TextStyle(
            ...
            Icon(Icons.card_giftcard_outlined,color: secondaryLight,),
          ],
        ),
      ),
    );
