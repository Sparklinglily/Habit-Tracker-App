...
class _StreakGridsState extends State<StreakGrids> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        children: [
          GridView.count(crossAxisCount: 2, mainAxisSpacing: 9, crossAxisSpacing: 9,shrinkWrap: true,
          children: [
